      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="dashboard-card mb-8">
          ...
          <p className="text-muted-foreground mb-4">
            Enter an IP address to see which regions would be recommended for
            optimal routing
          </p>
          ...
          {selectedRegion && (
            <div className="p-4 rounded-lg bg-success/10 border border-success/20">
              ...
              <p className="text-sm">
                Based on the IP location and current carbon intensity,{" "}
                <strong>US West (Oregon)</strong> is the optimal region with the
                lowest environmental impact and good performance.
              </p>
            </div>
          )}
        </Card>
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-muted-foreground">
                Real-time carbon intensity and performance metrics for all
                regions
              </p>
            </div>
            <Badge variant="secondary">
              <Wifi className="h-4 w-4 mr-2" />
              {regions?.length ?? 0} Regions Online
            </Badge>
          </div>
              ...
              >
                ...
                <div className="flex items-center justify-between mt-4 pt-4 border-t">
                  ...
                  <span className="font-semibold">
                    {region.requests24h.toLocaleString()}
                  </span>
                </div>
              </Card>
            ))}
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                          <span
                            className={`font-semibold ${getCarbonIntensityColor(
        ...
        <Card className="dashboard-card mt-8">
                ...
                <div className="flex-1 bg-muted rounded-full h-4 relative">
                  <div
                    className={`h-4 rounded-full ${
                      region.carbonIntensity < 100
                        ? "bg-success"
                        : region.carbonIntensity < 150
                        ? "bg-warning"
                        : "bg-destructive"
                    }`}
                    style={{
                      width: `${Math.min(
                        (region.carbonIntensity / 200) * 100,
                        100
                      )}%`,
                    }}
                  />
          ...
          <div className="mt-6 p-4 rounded-lg bg-muted/30">
            ...
            <p className="text-sm text-muted-foreground">
              Based on current carbon intensity, EU North (Stockholm) offers the
              cleanest energy with 45g CO₂/kWh. Consider routing
              non-latency-critical workloads to this region for maximum
